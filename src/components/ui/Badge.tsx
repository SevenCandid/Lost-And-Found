      ...
      <div
        ...
        className={cn(
          'inline-flex items-center justify-center rounded-full font-medium transition-colors',
          {
            ...
            'bg-transparent border border-border-color text-slate-600 dark:text-slate-300': variant === 'outline',
            
            'hover:bg-primary-200': isInteractive && variant === 'primary',
            'hover:bg-slate-200 dark:hover:bg-slate-700 cursor-pointer active:scale-95': isInteractive && variant === 'secondary',
            ...
            'hover:bg-slate-50 dark:hover:bg-slate-800 cursor-pointer': isInteractive && variant === 'outline',
